...
/// <summary>
/// A throwaway packs directory on the real filesystem, shared by every Library.Desktop test that
...
public sealed class TestPacks : IDisposable
{
    public TestPacks()
    {
        Path = System.IO.Path.Combine(System.IO.Path.GetTempPath(), $"dungeonapp-library-desktop-packs-{Guid.NewGuid():N}");
