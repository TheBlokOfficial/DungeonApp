...
/// <summary>
/// The narrow interface through which the engine asks systems about content types, without
/// ever seeing a materialized content record.
/// <para>
/// <see cref="HasSet"/> answers a narrower question than <see cref="TryGet"/>: whether any
/// installed system answers to this id at all, regardless of whether it declares the
...
/// cref="ContentPackLoader"/> can tell "no system answers to this id" apart from "a system
/// answers to this id, but does not declare this type" - see <see
...
/// deserialize twice - once here to validate, once more when the system actually builds a
