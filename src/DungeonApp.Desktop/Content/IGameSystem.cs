...
/// (<see cref="Id"/>) so an aggregate over several systems can find the right one for a given
/// reference.
/// <para>
...
public interface IGameSystem : IContentTypeCatalog, IContentPresentation
{
    ...
    /// <summary>
    /// The desk tools this system brings, built against the campaign named by
    /// <paramref name="context"/>. A system is the only place allowed to know what its own content
    ...
    /// Returns an empty list when this system brings none.
    /// </summary>
