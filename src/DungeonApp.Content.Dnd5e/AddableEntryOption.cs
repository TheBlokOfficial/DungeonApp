...
/// <summary>
/// One entry the campaign tool's "add" picker offers: resolved, and belonging to this system
/// (<see cref="Dnd5eSystem.Id"/>) - the only two things <see cref="CampaignInstancesToolViewModel"/>
